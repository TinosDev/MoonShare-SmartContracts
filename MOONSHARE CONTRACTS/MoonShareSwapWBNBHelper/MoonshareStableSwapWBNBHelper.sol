...
import "./Ownable.sol";
import "./IWBNB.sol";
import "./IMoonshareStableSwap.sol";

contract MoonshareStableSwapWBNBHelper is Ownable {
    ...
    function initSwapPair(IMoonshareStableSwap swap) internal {
